...
const MyAccount = () => {
  ...
  return (
    <>
      <header
        className={`${styles.paddingX} ${styles.flexStart} fixed top-0 w-full z-[101] bg-primary`}
      >
      ...
      <div className='bg-[#2F4F4F] h-[35vh] bg-[url("https://i.pinimg.com/originals/92/1e/41/921e416b732f173786e9e4a97b39c0f6.jpg")] bg-cover bg-center mt-[80px] relative'>
        <div
      ...
      >
        <div className={`${styles.boxWidth} text-white`}>
          <div className="flex justify-between items-center relative mt-[8rem] md:mt-[5rem] mb-[2rem]">
            <div>
              <p className={`${styles.heading3}`}>{user?.displayName}</p>
      ...
      >
        <div
          className={`${styles.boxWidth} text-white border-b border-[#3d3d3d]`}
        >
          <div className="md:flex my-[2rem]">
            <div className="md:w-[25%]">
              ...
              <ul className="mt-[1.5rem]">
                <li className="flex items-center gap-[.7rem] mb-[1rem]">
                  <FiMail size={20} className="text-secondary" />
                  {user?.email}
                </li>
                <li className="flex items-center gap-[.7rem]">
                  <FiPhone size={20} className="text-secondary" /> +57 313 123
                  4567
                </li>
              </ul>
            </div>
