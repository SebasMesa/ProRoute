...
const Account = () => {
  return (
    <>
      ...
      <div className='bg-[#2F4F4F] h-[35vh] bg-[url("https://c10.patreonusercontent.com/4/patreon-media/p/campaign/4890896/b7c236207a594ca0a2292950e93b4173/eyJ3IjoxNjAwLCJ3ZSI6MX0%3D/3.jpeg?token-time=1730678400&token-hash=SM_bu3yzZKkF6DX35a8IX5PIz8MjVbWLnL1t9xXE5J4%3D")] bg-cover bg-center mt-[80px]'></div>
