...
import Fundamentals from '@/pages/courses/fundamentals/Fundamentals';
import Databases from './pages/courses/databases/Databases';
      ...
      <Router>
        ...
        /> */}
          ...
          <Routes>
            ...
            <Route path="/courseIntroduction" element={
              <ProtectedRoute>
                <CourseIntroduction />
              </ProtectedRoute>
            } />
            ...
            <Route path="/course/fundamentals" element={
              <ProtectedRoute>
                <Fundamentals />
              </ProtectedRoute>
            } />

            <Route path="/course/databases" element={
              <ProtectedRoute>
                <Databases />
              </ProtectedRoute>
            } />
