...
import Card from '@/components/ui/TestimoniosCard';
  ...
  return (
    <div className={`${styles.paddingY} ${styles.flexCenter}`}>
      <div className='w-full'>
        <h2 className={`${styles.heading2} text-center`}>Testimonios</h2>

        <p className={`${styles.paragraph} text-center mt-5 w-[60%] mx-auto`}>Inspírate con historias de personas como tú que comenzaron su viaje en la programación con ProRoute y lograron alcanzar sus metas profesionales.  </p>
