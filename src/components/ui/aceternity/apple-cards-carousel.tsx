    ...
    >
      <div className="relative w-full">
        ...
        <div className="flex justify-end gap-2 mr-10">
          ...
          >
            <FaArrowAltCircleLeft className="h-6 w-6 text-gray-500" />
          </button>
          <button
            className="relative z-40 h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center disabled:opacity-50"
            onClick={scrollRight}
          ...
          >
            <FaArrowAltCircleRight className="h-6 w-6 text-gray-500" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
  ...
  return (
    <>
      <motion.button
        ...
        className="rounded-3xl bg-gray-100 bg-glass h-80 w-56 md:h-[32rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
    ...
    <div className='absolute w-[250px] h-[250px] blue__gradient top-[10rem] opacity-[.8] right-1'></div>
        ...
        <div className="relative z-40 p-8">
          ...
          <motion.p
            ...
            className={`${styles.paragraph} text-start mt-[2rem]`}
          >
            {card.description}
          </motion.p>
